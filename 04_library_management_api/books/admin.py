...
class BookCopyInline(admin.TabularInline):
    model = BookCopy
    extra = 1
    fields = ['copy_number', 'condition', 'location', 'is_available']
...
class BookCopyAdmin(admin.ModelAdmin):
    list_display = ['book', 'copy_number', 'condition', 'location', 'is_available', 'acquired_date']
    list_filter = ['condition', 'is_available', 'acquired_date']
    search_fields = ['book__title', 'copy_number', 'location']
